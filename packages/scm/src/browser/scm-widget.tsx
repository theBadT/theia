...
export class ScmWidget extends ScmNavigableListWidget<ScmResource> implements StatefulWidget {
    ...
    protected doShowMoreToolButtons(event: React.MouseEvent<HTMLElement>, path: string[] | undefined) {
        const el = (event.target as HTMLElement).parentElement;
        if (el) {
            this.contextMenuRenderer.render(path ? path : ScmWidget.ContextMenu.PATH, {
...
class ScmResourceItem extends React.Component<ScmResourceItem.Props> {
    ...
    render() {
        ...
        const renderContextMenu = (event: React.MouseEvent<HTMLElement>) => {
            ...
            this.props.renderContextMenu(event, ['scm-resource-context-menu_' + this.props.groupLabel]);
        };
